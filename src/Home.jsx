...
export default function Home() {
  return (
    <div>
        ...
        <section className='min-h-screen '>
          <nav className='pt-5 pb-5 mb-5 flex justify-between'>
            ...
            <ul className='flex items-center'>
              ...
              <li><a className='bg-emerald-700 hover:bg-emerald-800 text-white ml-8 p-3 rounded ' href='#'>Resume</a></li>
            </ul>
          </nav>
          ...
          <div className=' text-center px-10 pt-2 pb-2'>
            <h2 className=' text-5xl font-bold text-emerald-700 py-2'>Empowering Change through Code</h2>
        ...
        <div className="border-b-2 border-emerald-500"></div>

        <section className='text-center px-14 py-8'>
            <h2 className='text-4xl font-bold text-emerald-700 py-2 mb-2'>About</h2>
